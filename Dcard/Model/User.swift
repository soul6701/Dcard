...
public struct User {
    ...
    init(uid: String = "", lastName: String = "", firstName: String = "", birthday: String = "", sex: String = "", phone: String = "", address: String = "", password: String = "", avatar: String = "", friend: [String] = [String](), isVerified: Bool = true, facebookIsConnected: Bool = true, googleIsConnected: Bool = true, appleIsConnected: Bool = false, country: Country = Country(name: "台灣", alias: "TW", code: "+86"), card: Card = Card(id: "a_a", post: [], name: "野比大雄", photo: "https://firebasestorage.googleapis.com/v0/b/dcard-test-478e3.appspot.com/o/user%2Fa_a.png?alt=media&token=61936705-d591-43ac-ae87-96e77328e809", sex: "M", introduce: """
...
""", country: "日本", school: "私立臺灣肥宅學院", department: "邊緣人養成學系", article: "", birthday: "8月7日 獅子座", love: "只愛靜香"), createAt: String = "2010/09/20") {
        self.uid = uid
