...
public struct User {
    ...
    init(uid: String = "", lastName: String = "", firstName: String = "", birthday: String = "", sex: String = "", phone: String = "", address: String = "", password: String = "", avatar: String = "", friend: [String] = [String](), isVerified: Bool = true, facebookIsConnected: Bool = true, googleIsConnected: Bool = true, appleIsConnected: Bool = false, country: Country = Country(name: "台灣", alias: "TW", code: "+86"), createAt: String = "1900/09/20") {
        self.uid = uid
